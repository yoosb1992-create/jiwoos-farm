...
export const PLAYER_ASSET = {
  ...
  animations: {
    idle_down: { startFrame: 0, endFrame: 0, fps: 1, repeat: -1 },
    idle_up: { startFrame: 0, endFrame: 0, fps: 1, repeat: -1 },
    idle_left: { startFrame: 0, endFrame: 0, fps: 1, repeat: -1 },
    idle_right: { startFrame: 0, endFrame: 0, fps: 1, repeat: -1 },
    walk_down: { startFrame: 0, endFrame: 0, fps: 8, repeat: -1 },
    walk_up: { startFrame: 0, endFrame: 0, fps: 8, repeat: -1 },
    walk_left: { startFrame: 0, endFrame: 0, fps: 8, repeat: -1 },
    walk_right: { startFrame: 0, endFrame: 0, fps: 8, repeat: -1 },
    tool_down: { startFrame: 0, endFrame: 0, fps: 10, repeat: 0 },
