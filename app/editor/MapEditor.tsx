  ...
  return <main className="editor-shell">
    ...
    <div className="editor-workspace">
      <aside className="editor-sidebar">
        ...
        <div className="tool-list">{tools.map((entry) => <button key={entry.id} className={tool === entry.id ? "active" : ""} onClick={() => { setTool(entry.id); setSelection(null); }}>{entry.label}</button>)}</div>
